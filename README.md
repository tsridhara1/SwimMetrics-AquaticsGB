...
> Data & Design Hackathon 2026 in collaboration with **Aquatics GB** · University of Sheffield · Centre for Machine Intelligence
...
*The hero landing leads into a **Global Dominance** globe and an **Evolution of Elite** line chart. Both visualisations display worldwide data only and update dynamically when the stroke, distance, or gender filters are changed. By default the platform loads at **100m Freestyle (Male)** on startup. Country-level filters are not available in this view — the globe and chart always reflect the full global dataset for the selected event.*
...
| ❓ Contextual Help System | Every metric includes a **?** tooltip explaining how to read and interpret it |

---

## 🧭 Built for Everyone

SwimMetrics is designed to be intuitive for coaches, analysts, and federation staff — not just data scientists. Every metric across the platform is accompanied by a **question mark (?) icon** that provides a plain-English tip on how to read and act on that number. Whether it's interpreting a projection confidence band or understanding what "gap to leader" means in context, the help system ensures the data is accessible at every level.
...
This project was developed in partnership with **Aquatics GB** as part of the **Data & Design Hackathon 2026** hosted at the **University of Sheffield, Centre for Machine Intelligence**. We worked alongside GB performance staff to ensure the analytics reflected real coaching workflows rather than theoretical dashboards.
